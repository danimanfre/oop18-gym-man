...
/**
 * Controller for the work shift editor
 */
public class EditWorkShiftController implements Controller {
    ...
    private final Map<DayOfWeek, CheckBox> days = new HashMap<>();
    ...
    public EditWorkShiftController(
        ...
        final WorkShiftRepository shiftRepo,
    ...
    public void onDisplay() {
        ...
        if (shiftObj != null && WorkShift.class.isInstance(shiftObj)) {
            ...
            final Employee employee = this.employeeRepo.get(shift.getEmployeeId()).get();
    ...
    public void initialize() {
        ...
        this.lstEmployee.setCellFactory(listView -> new ListCell<Employee>() {
            @Override
            public void updateItem(final Employee item, final boolean empty) {
    ...
    public void onSaveClicked() {
        final WorkShift.WorkShiftBuilder workShiftBuilder = WorkShift.builder()
    ...
    /**
     * Enable or disable the save button depending on the form state
     */
    ...
    /**
     * Perform a search when the text is changed
     */
    public void onSearchTextChanged() {
        ...
        final List<Employee> result = this.employeeRepo.searchByName(query);
    ...
    private void setSelectedDays(final Set<DayOfWeek> days) {
