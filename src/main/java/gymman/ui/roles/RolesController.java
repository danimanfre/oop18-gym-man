...
public class RolesController implements Controller {
    ...
    private final ObservableList<Role> listData = FXCollections.observableArrayList();
    ...
    public void initialize() {
        ...
        buttonsFactory.addButton("Elimina", role -> {
            final Optional<ButtonType> res = this.alertDelete.showAndWait();
