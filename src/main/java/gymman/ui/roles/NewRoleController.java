...
/**
 * Controller for the role editor page
 */
public class NewRoleController implements Controller {
    ...
    private final Alert alertMissingName = new Alert(AlertType.WARNING, "'Name' needs to be filled out.");
    private final Alert alertDuplicateRole = new Alert(AlertType.WARNING, "A role with the same name already exists.");
    ...
    public void onDisplay() {
        this.clearForm();
        final List<Permission> permissions = this.authService.getRegisteredPermissions();
    ...
    public void onSaveClicked() {
        ...
        final Role.RoleBuilder roleBuilder = Role.builder().name(this.txtName.getText().trim())
