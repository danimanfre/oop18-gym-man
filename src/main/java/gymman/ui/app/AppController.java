...
public class AppController implements Controller {
    ...
    /**
     * This defines which and in which order the pages are to be displayed in the main menu
     */
    ...
    private void populateMenu() {
        ...
        final Button btnLogout = new Button("Esci");
    ...
    private Button createMenuButton(final Page page) {
        final Button btn = new Button(page.getTitle());
