...
public class ToolController implements Controller {
    ...
    public void onSearchTextChanged() {
        ...
        this.listTool.setAll(Stream.of(this.toolRepo.searchByName(text).stream(),
                this.toolRepo.searchByName(text).stream()).flatMap(e -> e).distinct().collect(Collectors.toList()));
    }
