...
public final class SearchUtils {
     ...
     */
    public static boolean containsAllWords(final String haystack, final String needle) {
     ...
     * @return true if matched, false otherwise
     */
    public static boolean containsAllWordsCaseInsensitive(final String haystack, final String needle) {
